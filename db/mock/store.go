...
// Source: github.com/mokshchadha/go_banks/db/sqlc (interfaces: Store)
...
// GetEntryViaAccId mocks base method.
func (m *MockStore) GetEntryViaAccId(arg0 context.Context, arg1 int64) (db.Entry, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetEntryViaAccId", arg0, arg1)
	ret0, _ := ret[0].(db.Entry)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetEntryViaAccId indicates an expected call of GetEntryViaAccId.
func (mr *MockStoreMockRecorder) GetEntryViaAccId(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetEntryViaAccId", reflect.TypeOf((*MockStore)(nil).GetEntryViaAccId), arg0, arg1)
}
